            ...
            <div class="carousel slide" data-bs-ride="carousel" id="carousel-1" style="height: 600px;">
                <div class="carousel-inner h-100" style="color: var(--bs-body-bg);">
                    <div class="carousel-item active h-100">
                        <img class="w-100 d-block position-absolute h-100 fit-cover" alt="Slide Image" src="assets/img/photo-1628191140023-d3b347041e2c.jpg" style="z-index: -1;">
                                    ...
                                    <div style="max-width: 350px;">
                                        <h1 class="text-uppercase fw-bold">
                                            <span style="color: rgb(0, 0, 0); background-color: rgb(255, 255, 255);">
                                                Aqui ira una frase con referencia a la empresa
                                            </span>
                                        </h1>
                                    </div>
                                </div>
                    ...
                    <div class="carousel-item h-100">
                        <img class="w-100 d-block position-absolute h-100 fit-cover" alt="Slide Image" src="assets/img/photo-1627662168223-7df99068099a-1.jpg" style="z-index: -1;">
                    ...
                    <div class="carousel-item h-100">
                        <img class="w-100 d-block position-absolute h-100 fit-cover" alt="Slide Image" src="assets/img/photo-1628191078376-f31a36c9f2cf.jpg" style="z-index: -1;">
